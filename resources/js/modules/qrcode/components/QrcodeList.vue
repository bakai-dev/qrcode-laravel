        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <router-link
                        :to="{name: 'Show Qrcode', params: {id: scope.row.id}}"
...
import {QRCODE_FETCH, QRCODE_OBTAIN} from '../store/types'
...
export default {
    ...
    computed: {
        ...mapGetters(['qrcodes', 'qrcodesMeta', 'qrcodesLoading']),
    },
    created() {
        this.fetchData()
    },
    ...
    methods: {
        ...mapActions([QRCODE_FETCH]),
        ...mapMutations([QRCODE_OBTAIN]),
        ...
        fetchData() {
            ...
            this[QRCODE_FETCH](params)
        },
        handleAdd() {
            this.formTitle = 'New Qrcode'
            this.formData = {}
            this.formVisible = true
        },
        handleEdit(row) {
            this.formTitle = 'Edit Qrcode'
            this.formData = Object.assign({}, row)
            this.formVisible = true
        },
        handleDelete(row) {
            this.$confirm('This will permanently delete the qrcode. Continue?', 'Warning', {
                type: 'warning'
            }).then(() => {
                qrcodeApi.delete(row.id).then((response) => {
                    this.$message({
